 ...
 * \ingroup TaskUtils
 */
PRIVILEGED_FUNCTION void vTaskGetRunTimeStats( char *pcWriteBuffer, uint16_t max_len ); /*lint !e971 Unqualified char types are allowed for strings and single characters only. */
